            ...
            <div className="relative group mt-9 md:mt-11 min-h-[180px] md:min-h-[220px] flex items-center justify-center w-full">
                {shouldHideCharacter ? (
                  ...
                  <div className="relative">
                    ...
                    {message && (
                      <div className="absolute -top-21 md:-top-22 left-1/2 transform -translate-x-1/2 w-64 md:w-72 text-center z-20 transition-all duration-500 animate-in fade-in slide-in-from-bottom-2 pointer-events-none">
